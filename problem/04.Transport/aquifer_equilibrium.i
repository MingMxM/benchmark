# Find the equilibrium free molality of SiO2(aq) when in contact with QuartzLike at 50 C
...
[TimeIndependentReactionSolver]
  ...
  constraint_value = "  1.0              0.1              0.1              1"
...
[Postprocessors]
    ...
    [bulk_QuartzLike]
        type = PointValue
        point = '0 0 0'
        variable = 'bulk_moles_QuartzLike'
    []
    [free_mg_QuartzLike]
        type = PointValue
        point = '0 0 0'
        variable = 'free_mg_QuartzLike'
    []
[]
