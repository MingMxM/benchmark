...
[SpatialReactionSolver]
    ...
    kinetic_species_initial_value = ' 1.06    1E-6    1E-6'
...
[AuxKernels]
  ...
  [rate_H2O_per_1l_auxk]
    ...
    expression = 'pf_rate_H2O / nodal_void_volume'
  ...
  [rate_HCO3_per_1l_auxk]
    ...
    expression = 'pf_rate_HCO3 / nodal_void_volume'
    execute_on = 'timestep_begin'
  []
  [rate_Ca_per_1l_auxk]
    type = ParsedAux
    ...
    expression = 'pf_rate_Ca / nodal_void_volume'
    execute_on = 'timestep_begin'
  []
  [rate_Mg_per_1l_auxk]
    type = ParsedAux
    ...
    expression = 'pf_rate_Mg / nodal_void_volume'
    execute_on = 'timestep_begin'
  []
  [rate_SiO2_per_1l_auxk]
    ...
    expression = 'pf_rate_SiO2 / nodal_void_volume'
    execute_on = 'timestep_begin'
  []
  [rate_H_per_1l_auxk]
    type = ParsedAux
    ...
    expression = 'pf_rate_H / nodal_void_volume'
    execute_on = 'timestep_begin'
  []
