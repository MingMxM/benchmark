...
[UserObjects]
    [definition]
        ...
        basis_species = "H2O H+ Ca++ Mg++ Al+++ SiO2(aq) HCO3-"
        equilibrium_minerals = "Anorthite Diopside Calcite Magnesite Amrph^silica"
...
[TimeDependentReactionSolver]
    ...
    constraint_species = "H2O              H+               Ca++             Mg++             Al+++              SiO2(aq)         CO2(g)"
    constraint_value = "  1.0              1E-7             0.4              0.4              0.0005             1E-6             4e-4"
    constraint_meaning = "kg_solvent_water bulk_composition bulk_composition bulk_composition free_concentration bulk_composition fugacity"
    constraint_unit = "   kg               moles            moles            moles            molal              moles            dimensionless"
    prevent_precipitation = "Calcite Magnesite Amrph^silica"
    ramp_max_ionic_strength_initial = 0
    initial_temperature = 100
    temperature = 100
    execute_console_output_on = 'initial timestep_end'
    source_species_names = "Anorthite Diopside"
    source_species_rates = "0.001    1.038"
    solver_info = true
    mol_cutoff = 1E-20
[]
